...
#define SSI0_CR1_TTRG_BIT	10 /* SSI0 TX trigger */
#define SSI0_CR1_TTRG_MASK	(0x3 << SSI0_CR1_TTRG_BIT)
  #define SSI_CR1_TTRG_1	  (0 << SSI0_CR1_TTRG_BIT)
  #define SSI_CR1_TTRG_4	  (1 << SSI0_CR1_TTRG_BIT)
  #define SSI_CR1_TTRG_8	  (2 << SSI0_CR1_TTRG_BIT)
  #define SSI_CR1_TTRG_14	  (3 << SSI0_CR1_TTRG_BIT)

#define SSI1_CR1_TTRG_BIT	16 /* SSI1 TX trigger */
#define SSI1_CR1_TTRG_MASK	(0xf << SSI1_CR1_TTRG_BIT) 
...
#define SSI0_CR1_RTRG_BIT	8 /* SSI0 RX trigger */
#define SSI0_CR1_RTRG_MASK	(0x3 << SSI0_CR1_RTRG_BIT)
  #define SSI0_CR1_RTRG_1	  (0 << SSI0_CR1_RTRG_BIT)
  #define SSI0_CR1_RTRG_4	  (1 << SSI0_CR1_RTRG_BIT)
  #define SSI0_CR1_RTRG_8	  (2 << SSI0_CR1_RTRG_BIT)
  #define SSI0_CR1_RTRG_14	  (3 << SSI0_CR1_RTRG_BIT)
#define SSI1_CR1_RTRG_BIT	8 /* SSI1 RX trigger */
#define SSI1_CR1_RTRG_MASK	(0xf << SSI1_CR1_RTRG_BIT)
