...
set(CMAKE_SYSROOT "${RELOCATED_HOST_DIR}/usr/mipsel-buildroot-linux-uclibc/sysroot")
...
if(0)
  ...
  set(CMAKE_Fortran_COMPILER "${RELOCATED_HOST_DIR}/usr/bin/mipsel-buildroot-linux-uclibc-gfortran")
endif()
